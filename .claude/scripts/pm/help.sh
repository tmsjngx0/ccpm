...
echo ""
echo "🧪 TDD Commands"
echo "  /pm:tdd [num]             - Work on issue with TDD methodology"
echo "  /pm:tdd-progress [num]    - Show TDD progress and metrics"
echo "  /pm:tdd-commit <phase>    - Create atomic TDD phase commits"
echo "  /pm:tdd-status            - Dashboard of all TDD activity"
echo "  /pm:completion-drive      - Track assumptions during coding"
echo ""
...
echo ""
echo "🔗 Sync & Migration Commands"
echo "  /pm:sync               - Full bidirectional sync with GitHub"
echo "  /pm:import [opts]      - Import existing GitHub issues"
echo "  /pm:tdd-convert [num]  - Convert issues to TDD workflow"
echo "  /pm:migration-report   - Show migration status"
echo ""
